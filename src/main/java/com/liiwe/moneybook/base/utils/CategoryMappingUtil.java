...
public class CategoryMappingUtil {
    ...
    public CategoryMappingUtil(SysCategoryService categoryService) {
        this.categoryService = categoryService;
    }

    /**
     * 旧模板中的分类名映射成新分类名后获取对应id
     * @param oldName 旧模板中的分类名
     */
    public int getCategoryId(String oldName){
        // 分类名映射
...
//        mapping.put("其它", "餐饮美食");
        ...
        String mappingName = mapping.getOrDefault(oldName,"未分类");
