...
//import com.liiwe.moneybook.service.base.MoneyBookService;
...
//
//    public MoneyBookServiceImpl(MoneyBookMapper moneyBookMapper, CategoryMapper categoryMapper, TransactionMapper transactionMapper) {
...
//            transaction.setTitle(moneyBook.getTitle());
//            transaction.setAmount(new BigDecimal(moneyBook.getAmount()));
//            transaction.setType(1);
//            transaction.setUid(3L);
//            transaction.setRemark(moneyBook.getRemark());
//
...
//        categoryQueryWrapper.eq(Category::getIsLeaf, 1);
//        categoryQueryWrapper.eq(Category::getIsActive, 1);
//
//        List<Category> categoryList = categoryMapper.selectList(categoryQueryWrapper);
//        Map<Integer, String> categoryMap = categoryList.stream().collect(Collectors.toMap(Category::getId, Category::getNamePath));
//
...
//            // 如果类型是支出，则累加到总支出
//            if (type.equals(Constants.TransType.EXPENSE)) {
